...
<section class="page-product-box blockproductscategory">
	<h2 class="productscategory_h3 page-product-heading">
		{if $categoryProducts|@count == 1}
			{l s='Related category:' sprintf=[$categoryProducts|@count] mod='productscategory'}
		{else}
			{l s='Related category:' sprintf=[$categoryProducts|@count] mod='productscategory'}
		{/if}
	</h2>
	<h4>
	{if $categoryProducts|@count == 1}
			{l s='%s product' sprintf=[$categoryProducts|@count] mod='productscategory'}
		{else}
			{l s='%s products' sprintf=[$categoryProducts|@count] mod='productscategory'}
		{/if}
	</h4>
